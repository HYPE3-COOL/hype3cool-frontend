...
const CoinCard = ({ coin }: CoinCardProps) => {
    ...
    return (
        <div className="coin-card w-full h-[335px] relative bg-slate-400/5 rounded-lg border-[0.5px] border-slate-400/15 overflow-hidden card-wrapper">
            <div className="card-content">
                <div className="px-6 py-6 h-full relative bg-black-100 hover:bg-slate-400/10 overflow-hidden shadow-inner flex flex-col justify-between">
                    <div>
                        <div className="flex flex-row space-x-5">
                            <div className="thumbnail-wrapper w-[100px] h-[100px]">
                                <div className="thumbnail-content">
                                    <img className="w-full h-full overflow-hidden" src={coin?.imageUri || '/assets/images/token-default-avatar.jpeg'} />
                                </div>
                            </div>
