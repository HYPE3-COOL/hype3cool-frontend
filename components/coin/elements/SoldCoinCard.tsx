...
const SoldCoinCard = ({ coin }: SoldCoinCardProps) => {
    return (
        <div className="coin-card w-full h-[335px] relative bg-slate-400/5 rounded-lg border border-slate-400/20 overflow-hidden card-wrapper">
            <div className="card-content">
                <div className="px-6 py-6 h-full relative bg-black-100 rounded-lg shadow-inner flex flex-col justify-between">
