...
const LottieGroup = () => {
    return (
        <div className="flex flex-row justify-center items-center my-10">
            ...
            >
                <LottieCard lottieUrl="xURXx4yW7o" index={1} lottieClassName="h-28 w-[140px]">
                    <>
            ...
            >
                <LottieCard lottieUrl="ops1BqFroK" index={2} lottieClassName="h-24 w-[120px]">
                    <>
            ...
            >
                <LottieCard lottieUrl="MvQsF7RPs2" index={3} lottieClassName="h-28 w-[140px]">
                    <>
...
const LottieCard = ({ lottieUrl, lottieClassName = 'h-24 w-[120px]', children, index }: LottieCardProps) => {
    return (
