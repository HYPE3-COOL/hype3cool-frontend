            ...
            <div className="flex flex-row items-center">
                <div className="min-w-[120px]">
                    <div className="flex items-center justify-center gap-x-10 h-10 my-auto">
                        <Link href={PAGE_LINKS.SITE_TWITTER_URL} target="_blank" className="text-white hover:text-white">
                            <span className="icon-x-twitter text-base"></span>
                        </Link>

                        <Link href={PAGE_LINKS.SITE_TELEGRAM_URL} target="_blank" className="text-white hover:text-white">
