...
import { AgentSocialsDialog, NewUserDialog, UpdateUsernameDialog, UploadImageDialog, WithdrawHoldingsDialog } from '@/components/layouts/dialogs';
                    ...
                    <div className="flex min-h-full items-center justify-center px-4 py-8">
                        ...
                        >
                            <DialogPanel className="w-full max-w-lg">
                                ...
                                {mainDialog.type === DIALOG_NAMES.AGENT_SOCIAL && <AgentSocialsDialog data={mainDialog.data as Agent} />}
                                {mainDialog.type === DIALOG_NAMES.WITHDRAW && <WithdrawHoldingsDialog />}
                            </DialogPanel>
                        </TransitionChild>
                    </div>
                </div>
