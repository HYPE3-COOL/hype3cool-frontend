...
const slice = createSlice({
    ...
    reducers: {
        ...
        setAgentFormStep(state, action) {
            state.agentFormStep = action.payload;
        },
        resetAgentFormStep(state) {
            state.agentFormStep = 1;
        }
    },
});

export default slice.reducer;
export const { openUploadProfilePic, closeUploadProfilePic, openSidePanel, closeSidePanel, setMainDialog, closeMainDialog, setAgentFormStep, resetAgentFormStep } = slice.actions;
