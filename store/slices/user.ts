...
const initialState: UserStateProps = {
    ...
    searchedUsers: [],
    updateAgentStatus: INITIAL_STATUS,
};
...
const slice = createSlice({
    ...
    reducers: {
        ...
        updateAgentFailure(state) {
            state.updateAgentStatus = 'failure';
        },
        updateAgentReset(state) {
            state.updateAgentStatus = 'idle';
        },
    },
});

export default slice.reducer;
export const { updateAgentStart, updateAgentSuccess, updateAgentFailure, updateAgentReset } = slice.actions;
